...
- Антипаттерн «экзамен»: вопрос «Почему/зачем X?» с 4 вариантами-объяснениями («Пролив слишком узкий» / «Дно поглощает энергию») - это эссе, а не выбор. Если вау - сама идентичность X (что это Балтийское море, прозвище «лаптёжник»), переверни: X в ОТВЕТ, механизм в explanation.
