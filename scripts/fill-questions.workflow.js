...
- «около/примерно» НЕ повторять в каждом варианте - это избыточный шум, убери из ВСЕХ (число и так приблизительное). И НЕ ставь хедж в ОДИН вариант среди голых - он выделяется как верный («Около 4 лет» среди «15 лет / 7 лет / 30 лет»); все 4 в одном формате. Перечисление в ответе - через союз «и», не запятой («Реки и проливы», НЕ «Реки, проливы»).
...
- НЕ бери живой рекорд/переходящий титул как ОТВЕТ («действующий рекорд ЧМ», «текущий чемпион», «самый кассовый») - протухает за сезон; бери устоявшийся факт.
