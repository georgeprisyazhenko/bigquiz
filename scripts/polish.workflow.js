...
9. ДЛИНА ОТВЕТОВ (жёсткий гейт src/content-rules.js): каждый вариант ≤3 ЗНАЧИМЫХ слова
   ...
   Все 4 варианта приводи к лимиту согласованно. Пример: «Соли кальция и магния» (4 слова) →
   «Соли кальция, магния» (3); «Лёд поглощает красный свет» → «Поглощает красный свет».
