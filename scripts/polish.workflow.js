...
1. ДИСТРАКТОРЫ: каждый правдоподобен и ОДНОЗНАЧНО неверен под текущую формулировку;
   ...
   ЗАМЫКАНИЕ: каждый дистрактор — полноценный грамматический ответ ИМЕННО на этот вопрос;
   обрубки/не-ответы («Французский физик», «Размер конюшни» на «откуда термин») и ответы из
   соседней темы — заменить (часто помогает смена угла вопроса).
...
9. ДЛИНА ОТВЕТОВ (жёсткий гейт src/content-rules.js): каждый вариант ≤3 ЗНАЧИМЫХ слова
   ...
   «и» («Реки и проливы», НЕ «Реки, проливы»). НО «и» только для РАЗНОРОДНОГО: НЕ склеивай два
   синонима в одном варианте («Болтовня и разговор», «Боль и страдание» - одно понятие дважды,
   оставь одно слово). Пример длины: «Все части птицы - каждая на отдельной шпажке» → «Птица на одной шпажке».
